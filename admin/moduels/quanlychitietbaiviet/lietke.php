...
$sql = "SELECT a.iddanhmuc, a.title, a.hinhanh, COUNT(ab.iddanhmuc) as block_count 
        FROM danhmucc a 
        -- LEFT JOIN chitietdanhmuc ab ON a.iddanhmuc = ab.article_id 
        LEFT JOIN chitietdanhmuc ab ON a.iddanhmuc = ab.iddanhmuc 
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="action-links">
                        <a href="quanlychitietbaiviet/chitiet.php?id=<?= $article['iddanhmuc'] ?>">Xem chi tiết</a>
                        <a href="index.php?action=suaCTbaiviet&id=<?= $article['iddanhmuc'] ?>">Sửa</a>
                        <a href="quanlychitietbaiviet/save_article.php?&id=<?= $article['iddanhmuc'] ?>" 
                           onclick="return confirm('Bạn có chắc chắn muốn xóa bài viết này?')">Xóa</a>
                    </td>
                    <td>
                        <?php if(!empty($article['hinhanh'])): ?>
                            <img src="quanlychitietbaiviet/uploads/<?= $article['hinhanh'] ?>" class="thumbnail">
                        <?php else: ?>
                            Không có hình ảnh
                        <?php endif; ?>
                    </td>
