<?php
    ...
    $manh = $_GET['id'];
    $sql_sua = "SELECT * FROM danhmucc WHERE iddanhmuc = '$manh'";
    $query_sua = mysqli_query($mysqli, $sql_sua);
    $row = mysqli_fetch_array($query_sua);
    
    // Lấy tất cả các block
    $sql_blocks = "SELECT * FROM chitietdanhmuc WHERE iddanhmuc = '$manh' ORDER BY sort_order ASC";
        ...
        <form action="quanlychitietbaiviet/save_article.php" method="post" enctype="multipart/form-data">
            ...
            <div>
                ...
                <?php if(!empty($row['hinhanh'])): ?>
                    <div>
                        <img src="quanlychitietbaiviet/uploads/<?php echo $row['hinhanh']; ?>" width="100px">
                        ...
                        <?php elseif($block['block_type'] === 'image'): ?>
                            <div style="margin-bottom: 10px;">
                                ...
                                <?php if(!empty($block['image_url'])): ?>
                                    <div>
                                        <img src="quanlychitietbaiviet/uploads/<?php echo $block['image_url']; ?>" style="max-width: 200px; max-height: 200px;">
            ...
            <div style="margin-top: 30px;">
                <input type="submit" name="suaCTbaiviet" value="Lưu bài viết" style="padding: 10px 20px; font-size: 16px;">
            </div>
        </form>
    </div>
