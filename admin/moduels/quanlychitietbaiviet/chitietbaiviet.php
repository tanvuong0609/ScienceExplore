...
<body>
    <div class="container">
        ...
        <?php while ($block = $blocks->fetch_assoc()): ?>
            ...
            <?php elseif ($block['block_type'] === 'image'): ?>
                ...
                <div class="image-block">
                    <!-- <img src="admin/moduels/quanlychitietbaiviet/uploads/<?= htmlspecialchars($block['image_url']) ?>"  -->
                    <img src="admin/moduels/quanlychitietbaiviet/uploads/<?= htmlspecialchars($block['image_url']) ?>" 
        ...
        <!-- <a href="../../moduels/index.php/quanlychitiettintuc/lietke.php" class="back-link">← Quay lại danh sách</a> -->
        <!-- <a href="../index.php?quanly=quanlychitiettintuc/lietke.php" class="back-link">← Quay lại danh sách</a> -->
        <!-- <a href="../index.php?action=quanlychitiettintuc" class="back-link">← Quay lại danh sách</a> -->
    </div>
    <div class="back-link">
    <a href="index.php?page=chuyende">Quay lại trang bài viết</a>
