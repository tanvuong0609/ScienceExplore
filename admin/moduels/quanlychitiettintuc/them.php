...
<body> 
    <div style="max-width: 800px; margin: 0 auto; padding: 20px;">
        <h2>Thêm bài tin tức</h2>
        <form action="quanlychitiettintuc/save_article.php" method="post" enctype="multipart/form-data">
            <div style="margin-bottom: 20px;">
                <label for="idtintuc">ID tin tức:</label>
                <input type="text" id="idtintuc" name="idtintuc" required style="padding: 10px; font-size: 16px;">
            </div>
            <div style="margin-bottom: 20px;">
            ...
            <div style="margin-top: 30px;">
                <input type="submit" name="themCTtintuc" value="Lưu bài viết" style="padding: 10px 20px; font-size: 16px;">
            </div>
        </form>
    </div> 
    <script>
