...
<body>
    ...
    <!-- <form action="quanlydanhmuc/xuly.php"method="POST"> -->
        <table border="1" width="50%" style="border-collapse: collapse;">
            <tr>
                <td><label for="IDtintuc">ID danh mục</label></td>
                <td><input type="text" id="idtintuc" name="idtintuc" required></td>
            </tr>
            <tr> 
                <td><label for="tentintuc">Tên danh mục</label></td>
                <td><input type="text" id="tentintuc" name="tentintuc" required></td>
            </tr>
            <tr>
            ...
            <tr>
                <td><label for="anHien">Ẩn hiện</label></td>
                <td><input type="text" id="anHien" name="anHien" required></td>
            </tr>
            <tr>
